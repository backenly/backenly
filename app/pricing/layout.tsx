...
export const metadata: Metadata = {
  ...
  description:
    'Backenly pricing: free forever plan (1 project, no credit card), Pro at $25/month, Enterprise custom. Every plan includes autonomous self-healing — company-funded, never billed to your AI credits.',
  keywords: [
    'Backenly pricing',
    'AI backend pricing',
