 ...
 *
 * Returns every AI-chat exchange this user has had, grouped by project.
 * Each message is a persisted ConversationMessage (role 'user' | 'ai') — i.e.
 * the exact prompt the user typed and the exact answer Backenly AI returned.
 * FOUNDER-ONLY.
 *
